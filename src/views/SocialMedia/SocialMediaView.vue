<template>
      ...
      <div v-else-if="socialMediaData.type === 3"><b-icon icon="github" aria-hidden="true"/> <a :href="'https://github.com/' + socialMediaData.name + '/'">{{ 'https://github.com/' + socialMediaData.name + '/'}}</a></div>
